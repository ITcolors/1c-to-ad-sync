...
# в файл ".\дата время.log"
# Аргумент - строка вида "строка".
# NB! конкатенация строк "строка1" + "строка2"
# не подходит в качестве аргумента
...
# Функция транслитерации для превращения
# строки "Фамилия ИО" пользователя
# в почтовый алиас
